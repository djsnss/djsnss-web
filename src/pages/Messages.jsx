...
import drharivasudevan from '../assets/Faculty/Hari Vasudevan.jpg';
import profvyankateshbagal from '../assets/Faculty/Vyankatesh Bagal.jpg';
import profalishabanz from '../assets/Faculty/Alisha Banz.jpg';
import profrahultaware from '../assets/Faculty/Rahul Taware.jpg';
...
const Messages = () => {
    ...
    return (
        <motion.div
            ...
            className="message-container w-full min-h-screen bg-cover flex bg-fixed bg-center text-justify"
            style={{ backgroundImage: `url(${Background})` }}
        >
            <div className='backdrop-blur-3xl pt-16 p-10 flex w-full flex-col md:flex-row items-center justify-center'>
                <div className='flex flex-col items-center justify-start w-full md:w-1/4'>
                    <h1 className="text-3xl font-bold mb-4 text-white">{messageData.name}</h1>
                    <h2 className="text-xl font-semibold text-white mb-6">{messageData.role}</h2>
                    <img src={messageData.image} alt={messageData.name} className="rounded-xl h-64 md:h-96 object-cover mb-6 text-white" />
                </div>
                <div className="message-content space-y-4 text-lg md:text-xl leading-relaxed text-white w-full md:w-3/4 md:pl-10">
