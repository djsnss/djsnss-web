...
//           <h1 className="text-4xl md:text-7xl font-bold tracking-wide text-white font-geist">Volunteer Policy</h1>
...
//               }}
//             >
              // <h2 className="text-white text-2xl md:text-5xl font-semibold text-center font-lateef">{section.title}</h2>
              // <div className="w-full h-full mt-3">
              //   {section.content.includes("-") ? (
              //     <ul className="list-disc pl-5 text-white font-roboto">
              //       {section.content
              //         .split("\n")
              ...
              //     </ul>
              //   ) : (
              //     <p className="text-white font-roboto">{section.content}</p>
              //   )}
              // </div>
//             </motion.div>
//           ))}
