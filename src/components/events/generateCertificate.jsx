        ...
        <div className="w-full mt-14 mb-2 flex flex-col justify-center items-center">
            ...
            >
                <div className="text-center mb-12">
                    <h1 className="text-lg sm:text-2xl lg:text-3xl font-bold mb-6 text-black font-geist">
                ...
                >
                    <Link
                        ...
                        className="inline-block px-6 py-3 bg-blue-500 text-white font-semibold rounded-full shadow-lg hover:bg-blue-600 transition duration-300 ease-in-out text-lg font-roboto"
                        target="_blank"
                        rel="noreferrer"
                    >
