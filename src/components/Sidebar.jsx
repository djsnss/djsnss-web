...
const Sidebar = () => {
  ...
  return (
    <nav
      className={`absolute sm:relative  sm:h-screen w-max sm:w-full p-2 shadow-lg border-r border-b border-white/20 sm:border-hidden backdrop-blur-lg transition-all duration-300 ease-in-out ${
        open ? "h-[100vh] w-[100vw] sm:w-60" : "h-max w-12 sm:w-16"
